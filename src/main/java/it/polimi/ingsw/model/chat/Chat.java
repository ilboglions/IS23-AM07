...
public class Chat {
    ...
    private PropertyChangeListener chatListener;
    ...
    public void postMessage(Message msg) throws SenderEqualsRecipientException {
        ...
        } else if (msg.getSender() == null || msg.getContent() == null || msg.getRecipient() == null) {
        ...
        // since we want to maintain a cronological order of the messages, we can use add. add puts the new element at the end of the list
    }
    ...
    public ArrayList<Message> getPlayerMessages(String player) {
        ...
        for(Message msg : sentMessages) {
            ...
            if( msg.getRecipient().isEmpty() || (msg.getRecipient().isPresent() && msg.getRecipient().get().equals(player)) || msg.getSender().equals(player) ) {
                playerMsgs.add(msg);
                // using add makes it possible to have the messages ordered in cronological order
            }
        }
        return playerMsgs;
    }
