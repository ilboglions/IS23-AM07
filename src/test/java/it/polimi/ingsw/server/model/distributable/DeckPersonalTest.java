...
class DeckPersonalTest {
    ...
    void testExceptions() {
        ...
        assertThrows(FileNotFoundException.class, ()->{
            DeckPersonal test = new DeckPersonal("src/test/java/it/polimi/ingsw/server/model/distributable/testConfFiles/deckPersonalTest.json", "");
            test.draw(3);
        });
        assertThrows(FileNotFoundException.class, ()->{
            DeckPersonal test = new DeckPersonal("", "src/test/java/it/polimi/ingsw/server/model/distributable/testConfFiles/pointsReferenceTest.json");
            test.draw(3);
        });
        assertThrows(NotEnoughCardsException.class, ()->{
            DeckPersonal test = new DeckPersonal("src/test/java/it/polimi/ingsw/server/model/distributable/testConfFiles/deckPersonalTest.json", "src/test/java/it/polimi/ingsw/server/model/distributable/testConfFiles/pointsReferenceTest.json");
            test.draw(100);
        });
        ...
        assertThrows(NullPointerException.class, ()->{
            DeckPersonal test = new DeckPersonal(null, "src/test/java/it/polimi/ingsw/server/model/distributable/testConfFiles/pointsReferenceTest.json");
        });
        assertThrows(NullPointerException.class, ()->{
            DeckPersonal test = new DeckPersonal("src/test/java/it/polimi/ingsw/server/model/distributable/testConfFiles/deckPersonalTest.json", null);
        });
    }
